...
class Noesis:
    ...
    def create_network_from_model(self, model, *args):
        ...
        ----------
        model : string
            Network formation model used to generate the network. See :any:`noesis.NetworkModel` for more details.
        args: parameters
            Parameters for the network formation model. See :any:`noesis.NetworkModel` for more details.
    ...
    def create_network_reader(self, reader, *args):
        ...
        ----------
        reader : string
            File format of the network reader. See :any:`noesis.NetworkReader` for more details.
        args: parameters
            Parameters for the network reader. See :any:`noesis.NetworkReader` for more details.
    ...
    def create_community_detector(self, detector, *args):
        ...
        ----------
        detector : string
            Technique used for community detection. See :any:`noesis.CommunityDetector` for more details.
        args: parameters
            Parameters for the community detector. See :any:`noesis.CommunityDetector` for more details.
    ...
    def create_layout(self, layout, *args):
        ...
        ----------
        layout : string
            Technique used to compute the layout. See :any:`noesis.Layout` for more details.
        args: parameters
            Parameters for the layout algorithm. See :any:`noesis.Layout` for more details.
    ...
    def create_node_scorer(self, scorer, *args):
        ...
        ----------
        scorer : string
            Technique used to compute node scores. See :any:`noesis.NodeScorer` for more details.
        args: parameters
            Parameters for the node scorer. See :any:`noesis.NodeScorer` for more details.
    ...
    def create_link_scorer(self, scorer, *args):
        ...
        ----------
        scorer : string
            Technique used to compute link scores. See :any:`noesis.LinkScorer` for more details.
        args: parameters
            Parameters for the link scorer. See :any:`noesis.LinkScorer` for more details.
    ...
    def create_link_predictor(self, predictor, *args):
        ...
        ----------
        scorer : string
            Technique used to compute node pair scores. See :any:`noesis.LinkPredictor` for more details.
        args: parameters
            Parameters for the link predictor. See :any:`noesis.LinkPredictor` for more details.
